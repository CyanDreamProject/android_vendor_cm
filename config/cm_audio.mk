...
ALARM_PATH := vendor/cyandream/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/cyandream/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/cyandream/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/cyandream/prebuilt/common/media/audio/ui
